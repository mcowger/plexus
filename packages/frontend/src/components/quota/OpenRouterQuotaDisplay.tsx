...
interface OpenRouterQuotaDisplayProps {
  result: QuotaCheckResult;
  isCollapsed: boolean;
}

export const OpenRouterQuotaDisplay: React.FC<OpenRouterQuotaDisplayProps> = ({
  result,
  isCollapsed,
}) => {
  if (!result.success) {
  ...
  return (
    <div className="px-2 py-1 space-y-1">
      <div className="flex items-center gap-2 min-w-0">
        ...
        <span className="text-xs font-semibold text-text whitespace-nowrap">OpenRouter</span>
      </div>
