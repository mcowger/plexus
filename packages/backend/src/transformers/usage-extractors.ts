 ...
 */
export function extractOpenAIUsage(dataStr: string): {
  input_tokens?: number;
 ...
 */
export function extractAnthropicUsage(dataStr: string): {
  input_tokens?: number;
  output_tokens?: number;
  cached_tokens?: number;
  reasoning_tokens?: number;
 ...
 */
export function extractGeminiUsage(dataStr: string): {
  input_tokens?: number;
  output_tokens?: number;
  cached_tokens?: number;
  reasoning_tokens?: number;
