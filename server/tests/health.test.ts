      ...
      providers: [
        {
          name: "provider-1",
          enabled: true,
          baseUrls: { chat: { url: "https://api.test1.com", enabled: true } },
        ...
        },
        {
          name: "provider-3",
          enabled: true,
          baseUrls: { chat: { url: "https://api.test3.com", enabled: true } },
        ...
        },
        {
          ...
          enabled: false,
          baseUrls: { chat: { url: "https://api.test4.com", enabled: true } },
