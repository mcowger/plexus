  ...
  providers: [
    {
      name: "openai",
      enabled: true,
      baseUrls: { chat: { url: "https://api.openai.com/v1/chat/completions", enabled: true } },
    ...
    },
    {
      name: "azure-openai",
      enabled: true,
      baseUrls: { chat: { url: "https://azure.openai.com", enabled: true } },
    ...
    },
    {
      ...
      enabled: false,
      baseUrls: { chat: { url: "https://disabled.com", enabled: true } },
